# Immutable Named Baseline Specification — v1.8.8
...
Baseline creation, supersession, and restoration events are included in the consolidated register. Register notes do not alter baseline snapshots.
