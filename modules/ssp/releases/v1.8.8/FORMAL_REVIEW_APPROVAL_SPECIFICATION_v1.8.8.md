# Formal Review and Approval Specification — v1.8.8
...
Formal approval is now the prerequisite for, but remains distinct from, immutable named baseline creation.

The consolidated register derives review, disposition, approval, revocation, and role-assignment entries without changing approval fingerprints.
