...
SOURCE=ROOT/'source'
BASELINE_ROOT=ROOT.parent/'v1.9.14'
BASELINE=BASELINE_ROOT/'CMMC_L2_SSP_Modern_Editable_v1.9.14.html'
BASELINE_MATERIALIZER=BASELINE_ROOT/'materialize.py'
OUTPUT=ROOT/'CMMC_L2_SSP_Modern_Editable_v1.9.15.html'
...
EXPECTED_BASELINE='8edd518e9b34b36c2d4795890e54412a12724ee54d758f97574f64764578d45e'
EXPECTED_PATCH='d14e3601765614ae7a20e1844c48fd26ca78759980914a4bb1c60fb2eba67aab'
EXPECTED_RUNTIME='5e3a628556fc63db777fbef813eee8df9e2d8a1405a81bd87c058012503f2361'
...
EXPECTED_ENCODED='0414bdd914babede5d29c1bb5491343ee0a4192cb41e601134908ff078211d08'
EXPECTED_XZ='e88a155d0f02cde0da21a6f11d545ecf65e4b27c4ba08c86a025026379d3b356'
...
ensure_baseline()
encoded=b''.join(b''.join(p.read_bytes().split()) for p in sorted(SOURCE.glob('runtime-v1.9.14-to-v1.9.15.patch.xz.b64.part*')))
