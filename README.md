...
| CMMC L2 SSP Modern Editable | v1.9.13 candidate | Independent review of issue #73 dark-mode Review/Needs Attention and compact toolbar correction; RG-4 remains the next mandatory SSP/Builder-Merger handshake release after promotion |

The promoted exact-version technical regression snapshot remains `suite-2026.07.26-workshop-v79-mcfirecoal-v1.2.0`. SSP v1.9.13 is an SSP-only visual-correction candidate over promoted v1.9.12. It themes the RG-2 Review Workspace and UX-3 Needs Attention workspace consistently in dark mode, aligns compact toolbar/state-strip controls, and prevents the autosave warning chip from clipping. It retains the v1.9.11 working-data schema, review profiles, Word Review behavior, package routes, and all cross-tool contracts. It introduces no Builder/Merger sidecar and makes no readiness, compliance, assessment, certification, final Word-QA, or client-release conclusion.
