...
| CMMC L2 SSP Modern Editable | v1.9.8 | RG-2 Local Staged-Review Orchestration is the next planned separately bounded SSP workstream; UX-3, Word inspection, Builder/Merger sidecars, custom profiles, bulk workflows, and adjacent-tool changes remain unauthorized |

The promoted exact-version technical regression snapshot remains `suite-2026.07.26-workshop-v79-mcfirecoal-v1.2.0`, which tested Control Center v0.3.4, DocConverter-L2G v7.9.5.1, Scoper v3.12, Workshop v79, Builder/Merger v3.8, and SSP v1.9.5.1 across all 10 required route groups. SSP v1.9.8 is now the separately promoted SSP release over v1.9.7. It adds the generic RG-1 source-preflight profile and deterministic migration to working-data identity 1.9.8 while preserving stable cross-tool contracts and package meanings. It does not rewrite the Workshop-v79 snapshot or authorize RG-2, UX-3, Word inspection, Builder/Merger sidecars, adjacent-module consumption, or any assessment, sufficiency, readiness, risk, compliance, certification, or scoring conclusion.
