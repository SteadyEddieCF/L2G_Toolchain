...
| CMMC L2 SSP Modern Editable | v1.9.15 candidate | Independent review of issue #79 Needs Attention work-area compaction; RG-4 remains the next mandatory SSP/Builder-Merger handshake release after promotion |

The promoted exact-version technical regression snapshot remains `suite-2026.07.26-workshop-v79-mcfirecoal-v1.2.0`. SSP v1.9.15 is an SSP-only UX candidate over promoted v1.9.14. It gives the derived Needs Attention queue substantially more laptop-height work area by adaptively collapsing the authority, filter, search, and count panel while preserving complete access through an explicit session-aware toggle. It retains the v1.9.11 working-data schema, review profiles, Word Review behavior, package routes, and all cross-tool contracts. It introduces no Builder/Merger sidecar and makes no readiness, compliance, assessment, certification, final Word-QA, or client-release conclusion.
