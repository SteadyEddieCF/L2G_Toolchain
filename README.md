...
| CMMC L2 SSP Modern Editable | v1.9.4 | v1.9.5 portfolio role coverage and responsibility matrix (suggested) |

These are the latest releases supplied to the repository bootstrap on 2026-07-23. The SSP pointer advances through the governed v1.9.3 module dependency visualization release and the v1.9.4 portfolio change calendar and review-cycle planning release. This table is not a claim that the six releases have completed one full end-to-end suite regression together.
