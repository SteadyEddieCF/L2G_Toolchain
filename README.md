...
| CMMC L2 SSP Modern Editable | v1.9.7 | RG-1 Generic Source-Preflight Review is the next separately bounded SSP workstream; no staged review, Word inspection, sidecar, or adjacent-tool change is implied |

The promoted exact-version technical regression snapshot remains `suite-2026.07.26-workshop-v79-mcfirecoal-v1.2.0`, which tested Control Center v0.3.4, DocConverter-L2G v7.9.5.1, Scoper v3.12, Workshop v79, Builder/Merger v3.8, and SSP v1.9.5.1 across all 10 required route groups. SSP v1.9.7 is promoted separately over SSP v1.9.6. It preserves SSP Handoff 1.0, SSP Return 1.0, all stable package identities, and the unchanged 1.9.5.1 governed working-data model. It does not rewrite the Workshop-v79 snapshot or authorize a review/delivery-profile contract, adjacent-module consumption, or any assessment, sufficiency, readiness, risk, compliance, certification, or scoring conclusion.
