...
| CMMC L2 Gap Workshop Tool | v79 promoted; v79.1 draft corrective candidate in PR #112 | Complete issue #105 final candidate-ID normalization, exact corrected Builder/Merger v3.10.1 round trip, and independent review; preserve proposed v80 Regression Delta workstream |
| L2G Builder/Merger | v3.10 promoted; v3.10.1 draft corrective candidate in PR #113 | Preserve the exact issue #106 nested governance-preservation candidate while Workshop v79.1 completes the exact joint round trip; v3.9 remains reserved for Advisor and Client Delivery Profiles |
