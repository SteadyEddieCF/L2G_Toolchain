...
| CMMC L2 SSP Modern Editable | v1.9.3 | v1.9.4 portfolio change calendar and review-cycle planning (suggested) |

These are the latest releases supplied to the repository bootstrap on 2026-07-23. The SSP pointer advances through the governed v1.9.2 evidence reminder release and the v1.9.3 module dependency visualization and export release. This table is not a claim that the six releases have completed one full end-to-end suite regression together.
