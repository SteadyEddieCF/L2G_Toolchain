...
| CMMC L2 SSP Modern Editable | v1.8.2 | v1.8.3 parent-change impact and conflict workflow |

These are the latest releases supplied to the repository bootstrap on 2026-07-17, with the SSP pointer advanced by its governed v1.8.2 deterministic-inheritance candidate. This table is not a claim that the six releases have completed one full end-to-end suite regression together.
