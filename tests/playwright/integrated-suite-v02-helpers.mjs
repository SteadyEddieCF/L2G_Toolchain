...
export const artifactPath = 'apps/integrated-suite-v0.2/dist/L2G_Integrated_Suite_Encrypted_Project_v0.2.0.html';
export const artifactUrl = `/${artifactPath}`;
export const fixtureDir = path.resolve('apps/integrated-suite-v0.2/build/fixtures');
