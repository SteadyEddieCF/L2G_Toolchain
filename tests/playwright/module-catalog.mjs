export const modules = [
  ...
  { slug: 'workshop-v77', name: 'CMMC L2 Gap Workshop Tool', version: 'v77', path: '/modules/workshop/releases/v77/cmmc_l2_gap_workshop_tool_v77.html', darkStrategy: 'dark-mode' },
  { slug: 'builder-merger-v3.8', name: 'L2G Builder/Merger', version: 'v3.8', path: '/modules/builder-merger/releases/v3.8/L2G-BM_v3.8.html' },
  { slug: 'ssp-v1.7', name: 'CMMC L2 SSP Modern Editable', version: 'v1.9.6', path: '/modules/ssp/releases/v1.9.6/CMMC_L2_SSP_Modern_Editable_v1.9.6.html', darkStrategy: 'body-dark', visual: false }
];
