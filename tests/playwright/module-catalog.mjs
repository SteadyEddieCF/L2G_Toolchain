export const modules = [
  ...
  { slug: 'ssp-v1.7', name: 'CMMC L2 SSP Modern Editable', version: 'v1.9.2', path: '/modules/ssp/releases/v1.9.2/CMMC_L2_SSP_Modern_Editable_v1.9.2.html', darkStrategy: 'body-dark' }
];
...
export async function applyDarkMode(page, strategy) {
  await page.evaluate((mode) => {
    if (mode === 'data-theme') document.documentElement.setAttribute('data-theme', 'dark');
    else if (mode === 'dark-mode') { document.documentElement.classList.add('dark-mode'); document.body.classList.add('dark-mode'); }
    else if (mode === 'body-dark') document.body.classList.add('dark');
  }, strategy);
