export const modules = [
  ...
  { slug: 'ssp-v1.7', name: 'CMMC L2 SSP Modern Editable', version: 'v1.9.5', path: '/modules/ssp/releases/v1.9.5/CMMC_L2_SSP_Modern_Editable_v1.9.5.html', darkStrategy: 'body-dark' }
];
