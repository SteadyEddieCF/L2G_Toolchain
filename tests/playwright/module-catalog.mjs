export const modules = [
  ...
  { slug: 'workshop-v79.1', name: 'CMMC L2 Gap Workshop Tool', version: 'v79.1', path: '/modules/workshop/releases/v79.1/cmmc_l2_gap_workshop_tool_v79.1.html', darkStrategy: 'dark-mode', visualBaselineSlug: 'workshop-v77', visualBaselineVersion: 'v77' },
  ...
  { slug: 'ssp-v1.9.17', name: 'CMMC L2 SSP Modern Editable', version: 'v1.9.17', path: '/modules/ssp/releases/v1.9.17/CMMC_L2_SSP_Modern_Editable_v1.9.17.html', darkStrategy: 'body-dark', visual: false }
];
...
export async function applyDarkMode(page, strategy) { await page.evaluate((mode) => { if (mode === 'data-theme') document.documentElement.setAttribute('data-theme', 'dark'); else if (mode === 'dark-mode') { document.documentElement.classList.add('dark-mode'); document.body.classList.add('dark-mode'); } else if (mode === 'body-dark') document.body.classList.add('dark'); }, strategy); await page.waitForTimeout(250); }
