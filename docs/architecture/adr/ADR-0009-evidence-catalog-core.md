...
75. Client projections omit original filenames, raw import package names, local collection hints, fingerprints unless specifically approved for presentation, parser diagnostics, confidence, provenance, internal exception details, duplicate rationale, candidate mappings, verification receipts, and inspector content.
